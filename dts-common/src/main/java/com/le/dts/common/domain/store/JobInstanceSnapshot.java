...
public class JobInstanceSnapshot {
	...
	public String toString() {
		return "JobInstanceSnapshot [id=" + id + ", gmtCreate=" + gmtCreate
				+ ", gmtModified=" + gmtModified + ", jobId=" + jobId
				+ ", fireTime=" + fireTime + ", status=" + status
				+ ", description=" + description + ", jobInstanceResult="
				+ jobInstanceResult + ", instanceGlobal="
				+ Arrays.toString(instanceGlobal) + ", offset=" + offset
				+ ", lockVersion=" + lockVersion + ", retryCount=" + retryCount
				+ ", nextRetryTime=" + nextRetryTime + ", notifyVersion="
				+ notifyVersion + ", relationTag=" + relationTag
