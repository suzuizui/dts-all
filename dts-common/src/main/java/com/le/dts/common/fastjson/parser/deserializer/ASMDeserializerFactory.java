...
import com.le.dts.common.fastjson.parser.DefaultJSONParser.ResolveTask;
import com.le.dts.common.fastjson.parser.Feature;
import com.le.dts.common.fastjson.parser.JSONLexer;
import com.le.dts.common.fastjson.parser.JSONLexerBase;
import com.le.dts.common.fastjson.parser.JSONToken;
import com.le.dts.common.fastjson.parser.ParseContext;
import com.le.dts.common.fastjson.parser.ParserConfig;
import com.le.dts.common.fastjson.parser.SymbolTable;
import com.le.dts.common.fastjson.parser.deserializer.ASMJavaBeanDeserializer.InnerJavaBeanDeserializer;
...
import com.le.dts.common.fastjson.asm.Label;
import com.le.dts.common.fastjson.asm.Opcodes;
import com.le.dts.common.fastjson.parser.*;
import com.le.dts.common.fastjson.util.ASMClassLoader;
import com.le.dts.common.fastjson.util.ASMUtils;
import com.le.dts.common.fastjson.util.DeserializeBeanInfo;
import com.le.dts.common.fastjson.util.FieldInfo;
...
public class ASMDeserializerFactory implements Opcodes {
    ...
    void _deserialzeArrayMapping(ClassWriter cw, Context context) {
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == byte.class //
                ...
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitLdcInsn(com.le.dts.common.fastjson.asm.Type.getType(ASMUtils.getDesc(fieldClass)));
                ...
                if (itemClass == String.class) {
                    ...
                    mw.visitVarInsn(ALOAD, 1);
                    mw.visitLdcInsn(com.le.dts.common.fastjson.asm.Type.getType(ASMUtils.getDesc(itemClass)));
    ...
    void _deserialze(ClassWriter cw, Context context) {
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(DefaultJSONParser.class), "getContext",
                           "()Lcom/le/dts/common/fastjson/parser/ParseContext;");
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == boolean.class) {
                ...
                if (itemClass == String.class) {
                    mw.visitLdcInsn(com.le.dts.common.fastjson.asm.Type.getType(ASMUtils.getDesc(fieldClass))); // cast
    ...
    private void _deserialze_list_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitFieldInsn(GETFIELD, context.getClassName(), fieldInfo.getName() + "_asm_list_item_deser__",
                          ASMUtils.getDesc(ObjectDeserializer.class));
        mw.visitVarInsn(ALOAD, 1);
        mw.visitLdcInsn(com.le.dts.common.fastjson.asm.Type.getType(ASMUtils.getDesc(itemType)));
    ...
    private void _deserObject(Context context, MethodVisitor mw, FieldInfo fieldInfo, Class<?> fieldClass) {
        ...
        if (fieldInfo.getFieldType() instanceof Class) {
            mw.visitLdcInsn(com.le.dts.common.fastjson.asm.Type.getType(ASMUtils.getDesc(fieldInfo.getFieldClass())));
        } else {
            mw.visitVarInsn(ALOAD, 0);
            mw.visitLdcInsn(fieldInfo.getName());
