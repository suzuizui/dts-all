...
import static com.le.dts.common.fastjson.util.ASMUtils.getDesc;
import static com.le.dts.common.fastjson.util.ASMUtils.getType;
...
import com.le.dts.common.fastjson.annotation.JSONField;
import com.le.dts.common.fastjson.annotation.JSONType;
import com.le.dts.common.fastjson.asm.ClassWriter;
import com.le.dts.common.fastjson.asm.FieldVisitor;
import com.le.dts.common.fastjson.asm.Label;
import com.le.dts.common.fastjson.asm.MethodVisitor;
import com.le.dts.common.fastjson.asm.Opcodes;
import com.le.dts.common.fastjson.util.ASMClassLoader;
...
public class ASMSerializerFactory implements Opcodes {
    ...
    public ObjectSerializer createJavaBeanSerializer(Class<?> clazz, Map<String, String> aliasMap) throws Exception {
        ...
        cw.visit(V1_5, ACC_PUBLIC + ACC_SUPER, className, "java/lang/Object",
                 new String[] { "com/le/dts/common/fastjson/serializer/ObjectSerializer" });
        ...
        for (FieldInfo fieldInfo : getters) {
            ...
            mw.visitLdcInsn(com.le.dts.common.fastjson.asm.Type.getType(getDesc(fieldInfo.getDeclaringClass())));
...

        {
            ...
            mw = cw.visitMethod(ACC_PUBLIC,
                                "write",
                                "(Lcom/le/dts/common/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/reflect/Type;)V",
        ...
        // "/usr/le/workspace-3.7/fastjson-asm/target/classes/"
        // + className + ".class"));
    ...
    private void generateWriteMethod(Class<?> clazz, MethodVisitor mw, List<FieldInfo> getters, Context context)
...

        {
            ...
            mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(JavaBeanSerializer.class), "writeReference",
                               "(Lcom/le/dts/common/fastjson/serializer/JSONSerializer;Ljava/lang/Object;)V");
...

        {
            ...
            mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(JSONSerializer.class), "getContext",
                               "()Lcom/le/dts/common/fastjson/serializer/SerialContext;");
            ...
            mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(JSONSerializer.class), "setContext",
                               "(Lcom/le/dts/common/fastjson/serializer/SerialContext;Ljava/lang/Object;Ljava/lang/Object;)V");
        }
        ...
        mw.visitVarInsn(ALOAD, context.var("parent"));
        mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(JSONSerializer.class), "setContext",
                           "(Lcom/le/dts/common/fastjson/serializer/SerialContext;)V");
    ...
    private void initNature(Class<?> clazz, MethodVisitor mw, Context context) {
        ...
        mw.visitInsn(DUP);
        mw.visitLdcInsn(com.le.dts.common.fastjson.asm.Type.getType(ASMUtils.getDesc(clazz)));
...

        {
            ...
            if (elementType == String.class) {
                ...
                if (elementClass != null && Modifier.isPublic(elementClass.getModifiers())) {
                    mw.visitLdcInsn(com.le.dts.common.fastjson.asm.Type.getType(ASMUtils.getDesc((Class<?>) elementType)));
                    mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(JSONSerializer.class), "writeWithFieldName",
                                       "(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/reflect/Type;)V");
                } else {
                    mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(JSONSerializer.class), "writeWithFieldName",
    ...
    private void _nameApply(MethodVisitor mw, FieldInfo property, Context context, Label _end) {
        ...
        mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "applyName",
                           "(Lcom/le/dts/common/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;)Z");
        mw.visitJumpInsn(IFEQ, _end);
    }
    ...
    private void _before(MethodVisitor mw, Context context) {
        ...
        mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "writeBefore",
                           "(Lcom/le/dts/common/fastjson/serializer/JSONSerializer;Ljava/lang/Object;C)C");
        mw.visitVarInsn(ISTORE, context.var("seperator"));
    }
    ...
    private void _apply(MethodVisitor mw, FieldInfo property, Context context) {
        ...
        if (propertyClass == byte.class) {
            ...
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "apply",
                               "(Lcom/le/dts/common/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;B)Z");
        } else if (propertyClass == short.class) {
            mw.visitVarInsn(ILOAD, context.var("short"));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "apply",
                               "(Lcom/le/dts/common/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;S)Z");
        } else if (propertyClass == int.class) {
            mw.visitVarInsn(ILOAD, context.var("int"));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "apply",
                               "(Lcom/le/dts/common/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;I)Z");
        } else if (propertyClass == char.class) {
            mw.visitVarInsn(ILOAD, context.var("char"));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "apply",
                               "(Lcom/le/dts/common/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;C)Z");
        } else if (propertyClass == long.class) {
            mw.visitVarInsn(LLOAD, context.var("long", 2));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "apply",
                               "(Lcom/le/dts/common/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;J)Z");
        } else if (propertyClass == float.class) {
            mw.visitVarInsn(FLOAD, context.var("float"));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "apply",
                               "(Lcom/le/dts/common/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;F)Z");
        } else if (propertyClass == double.class) {
            mw.visitVarInsn(DLOAD, context.var("double", 2));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "apply",
                               "(Lcom/le/dts/common/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;D)Z");
        } else if (propertyClass == boolean.class) {
            mw.visitVarInsn(ILOAD, context.var("boolean"));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "apply",
                               "(Lcom/le/dts/common/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;B)Z");
            ...
            mw.visitVarInsn(ALOAD, context.var("decimal"));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "apply",
                               "(Lcom/le/dts/common/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Z");
        } else if (propertyClass == String.class) {
            mw.visitVarInsn(ALOAD, context.var("string"));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "apply",
                               "(Lcom/le/dts/common/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Z");
    ...
    private void _processValue(MethodVisitor mw, FieldInfo property, Context context) {
        ...
        mw.visitMethodInsn(INVOKESTATIC,
                           ...
                           "processValue",
                           "(Lcom/le/dts/common/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;");
    ...
    private void _processKey(MethodVisitor mw, FieldInfo property, Context context) {
        ...
        if (propertyClass == byte.class) {
            ...
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "processKey",
                               "(Lcom/le/dts/common/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;B)Ljava/lang/String;");
        } else if (propertyClass == short.class) {
            mw.visitVarInsn(ILOAD, context.var("short"));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "processKey",
                               "(Lcom/le/dts/common/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;S)Ljava/lang/String;");
        } else if (propertyClass == int.class) {
            mw.visitVarInsn(ILOAD, context.var("int"));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "processKey",
                               "(Lcom/le/dts/common/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;I)Ljava/lang/String;");
        } else if (propertyClass == char.class) {
            mw.visitVarInsn(ILOAD, context.var("char"));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "processKey",
                               "(Lcom/le/dts/common/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;C)Ljava/lang/String;");
        } else if (propertyClass == long.class) {
            mw.visitVarInsn(LLOAD, context.var("long", 2));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "processKey",
                               "(Lcom/le/dts/common/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;J)Ljava/lang/String;");
        } else if (propertyClass == float.class) {
            mw.visitVarInsn(FLOAD, context.var("float"));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "processKey",
                               "(Lcom/le/dts/common/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;F)Ljava/lang/String;");
        } else if (propertyClass == double.class) {
            mw.visitVarInsn(DLOAD, context.var("double", 2));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "processKey",
                               "(Lcom/le/dts/common/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;D)Ljava/lang/String;");
        } else if (propertyClass == boolean.class) {
            mw.visitVarInsn(ILOAD, context.var("boolean"));
            mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "processKey",
                               "(Lcom/le/dts/common/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;Z)Ljava/lang/String;");
        } else if (propertyClass == BigDecimal.class) {
            mw.visitVarInsn(ALOAD, context.var("decimal"));
            mw.visitMethodInsn(INVOKESTATIC,
                               ASMUtils.getType(FilterUtils.class),
                               "processKey",
                               "(Lcom/le/dts/common/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;");
        } else if (propertyClass == String.class) {
            mw.visitVarInsn(ALOAD, context.var("string"));
            mw.visitMethodInsn(INVOKESTATIC,
                               ASMUtils.getType(FilterUtils.class),
