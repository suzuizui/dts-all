 ...
 *
 * @version:    1.0
 * Filename:    AbstractPageQuery.java
 * Create at:   Feb 22, 2011 10:36:01 AM
 *
...
public abstract class BasePageQuery implements Serializable {
	private static final long serialVersionUID = 6318658398155372579L;
	 ...
	 */
	public BasePageQuery setAjaxPrefix(String ajaxPrefix) {
	 ...
	 */
	public BasePageQuery setAjaxSuffix(String ajaxSuffix) {
	 ...
	 */
	public BasePageQuery setCharset(String charset) {
	 ...
	 * @return
	 */
	public BasePageQuery remove(Object key) {
	 ...
	 * @return
	 */
	public BasePageQuery replace(Object key, Object val) {
		if (null != key && null != val) {
			if (null == this.tempParam)
				this.tempParam = new HashMap<String, Object>(5);
	 ...
	 */
	public BasePageQuery setEscape(boolean escape) {
		this.escape = escape;
		return this;
	}
	 ...
	 */
	public final BasePageQuery setJsEscape(boolean jsEscape) {
