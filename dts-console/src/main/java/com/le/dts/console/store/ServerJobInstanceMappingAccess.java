...
public interface ServerJobInstanceMappingAccess {
    ...
    public List<ServerJobInstanceMapping> loadAll(long id) throws AccessException;
    
    public List<ServerJobInstanceMapping> selectLimit() throws AccessException;
    
    public int deleteById(ServerJobInstanceMapping serverJobInstanceMapping) throws AccessException;
